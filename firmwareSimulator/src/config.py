...
CERT_FILE_PATH = "../firmwareSimulator/certificates/firmwareSimulatorThing.cert.pem"
PRI_KEY_FILE_PATH = "../firmwareSimulator/certificates/firmwareSimulatorThing.private.key"
ROOT_PEM_FILE_PATH = "../firmwareSimulator/certificates/root.pem"
AWS_ENDPOINT = "a2aclgd4nh1dkk-ats.iot.eu-north-1.amazonaws.com"
PUB_KEY_FILE_PATH = '../firmwareSimulator/certificates/firmwareSimulatorThing.public.key'
PATH_TO_DODECAHEDRON = '../firmwareSimulator/dodecahedron/dodecahedron.json'
#---------------------------------------------------------------------------
#                                  Constants                  
#---------------------------------------------------------------------------
...
THING_NAME = CLIENT_ID = 'firmwareSimulatorThing'
